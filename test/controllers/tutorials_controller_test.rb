...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { content: @tutorial.content, image: @tutorial.image, intro: @tutorial.intro, published: @tutorial.published, slug: @tutorial.slug, title: @tutorial.title, user_id: @tutorial.user_id }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { content: @tutorial.content, image: @tutorial.image, intro: @tutorial.intro, published: @tutorial.published, slug: @tutorial.slug, title: @tutorial.title, user_id: @tutorial.user_id }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
